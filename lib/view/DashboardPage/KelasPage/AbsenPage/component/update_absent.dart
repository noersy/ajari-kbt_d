...
class DialogUpdateAbsen extends StatefulWidget {
  final DateTime date;
  final DateTime startAt;
  final DateTime endAt;
  final String id;

  const DialogUpdateAbsen({Key? key, required this.date, required this.startAt, required this.endAt, required this.id}) : super(key: key);

  @override
  State<DialogUpdateAbsen> createState() => _DialogUpdateAbsenState();
}

class _DialogUpdateAbsenState extends State<DialogUpdateAbsen> {
  ...
  void initState() {
    ...
    _stringTimeStartAt = formattedTime.format(widget.startAt);
    _stringTimeEndAt = formattedTime.format(widget.endAt);

    selectedDate = widget.date;
    selectedTimeStart = widget.startAt;
    selectedTimeEnd = widget.endAt;
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Provider.of<KelasProvider>(context, listen: false).updateAbsen(
                      ...
                      Navigator.of(context).pop("Success update absent.");
                    },
                    child: Text(
                      'Submit',
